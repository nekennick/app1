...
class Boitheoten extends StatefulWidget {
  const Boitheoten({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _BoitheotenState createState() => _BoitheotenState();
}

class _BoitheotenState extends State<Boitheoten> {
  String name1 = '';
  String name2 = '';
